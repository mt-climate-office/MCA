...
dplyr::select(extremes, name, period, value) %>% 
  ...
  dplyr::mutate(
    name = dplyr::recode(
      ...
      monthly_max = "Max Monthly Temperature",
      monthly_min = "Min Monthly Temperature"
    ),
    period = dplyr::recode(
      period,
      start = "1951–1980",
